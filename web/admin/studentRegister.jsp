...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form name="fom" action="servlet/myAdminServlet?method=doAddStudent"	id="fom" method="post">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>学生编号:</td>
													<td>
														<input name="sno" type="text" class="text" style="width:154px" value="" />
													</td>
												</tr>
												...
												<tr>
													<td>学生姓名:</td>
													<td>
														<input name="sname" type="text" class="text" style="width:154px" value="" />
													</td>
												</tr>
												...
												<tr>
													<td>出生日期:</td>
													<td>
														<input class="text" name='birth' style="width:154px" value="" />
													</td>
												</tr>
												<tr>
													<td>班级:</td>
													<td>
														<select name="clazzno" class="text">
															...
															<c:forEach items="${clazzlist }" var="c">
																<option value="${c.clazzno }">${c.cname }</option>
															</c:forEach>
														</select>
													</td>
												</tr>
