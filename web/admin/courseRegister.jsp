...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form action="servlet/myAdminServlet?method=doAddCourse" name="fom" id="fom" method="post">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>开课日期:</td>
													<td>
														<input class="text" name='periodStart' style="width:154px" readonly="readonly" onfocus="WdatePicker()"/>
													</td>
												</tr>
												...
												<tr>
													<td>结课日期:</td>
													<td>
														<input class="text" type="text" name="periodEnd" style="width:154px" readonly="readonly" onfocus="WdatePicker()"/> </td>
												</tr>
											</table>
											<br />
										</fieldset>
